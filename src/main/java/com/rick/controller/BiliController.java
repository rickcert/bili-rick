...
public class BiliController {
     ...
     * @return
     */
    @GetMapping("/audio/{avid}/{cid}")
    public String getAudioUrl(@PathVariable("avid") String avid, @PathVariable("cid") String cid) {
        return HttpUtil.createGet("https://api.bilibili.com/x/player/playurl?avid=" + avid + "&cid=" + cid + "&fnval=4048").execute().body();
    }
}
